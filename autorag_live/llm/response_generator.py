        ...
        **kwargs: Any,
        ...
        if sources:
            ...
            if include_citations:
                combined_text, used = self.injector.inject_citations(combined_text, sources)
    ...
    def generate(
        ...
        **kwargs: Any,
        ...
        if include_citations and sources:
            generated_text, citations_used = self.injector.inject_citations(generated_text, sources)
...
class ConfidenceScorer:
    ...
    def score(
        ...
        # Weighted average
        confidence = source_factor * 0.3 + relevance_factor * 0.5 + citation_factor * 0.2
